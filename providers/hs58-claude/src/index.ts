 ...
 * and proxies to Anthropic Claude.
 */
...
║  Models:    ${getSupportedModels(config).slice(0, 3).join(', ')}...    ║
║  Markup:    50% on Anthropic prices                            ║
╚═══════════════════════════════════════════════════════════════╝

Endpoints:
  GET  /v1/pricing           - View pricing (with 50% markup)
